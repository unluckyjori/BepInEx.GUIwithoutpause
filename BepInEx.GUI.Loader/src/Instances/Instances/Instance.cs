...
namespace Instances
{
    ...
    {
        public static ProcessInstance Start(string path, string arguments = "", EventHandler<string>? outputHandler = default, EventHandler<string>? errorHandler = default)
        {
            return Start(new ProcessStartInfo { FileName = path, Arguments = arguments }, outputHandler, errorHandler);
        }

        public static ProcessInstance Start(ProcessStartInfo startInfo, EventHandler<string>? outputHandler, EventHandler<string>? errorHandler)
        {
